...
export class InsultGenerator {
  private readonly insults: InsultTemplate[] = [
    ...
    {
      template:
        "{opponent}, you're so slow that even Internet Explorer feels bad for you!",
    ...
    {
      template:
        "{opponent}, your IQ is so low that you make a rock look like Einstein!",
      category: "intelligence",
    },
    {
      template:
        "Listen up {opponent}, you're about as sharp as a bowling ball!",
      category: "intelligence",
    },
    ...
    {
      template:
        "{opponent}, your skills are so bad that even a tutorial would give up on you!",
      category: "skills",
    },
    {
      template:
        "Yo {opponent}, you're so bad at this that they should create a new difficulty level called 'Impossible for {opponent}'!",
      category: "skills",
    },
    {
      template:
        "{opponent}, you play like you learned from a YouTube video... that was buffering!",
      category: "skills",
    },
    {
    ...
    {
      template:
        "{opponent}, your code is so buggy that even mosquitoes are jealous!",
      category: "tech",
    },
    {
      template:
        "Sup {opponent}, you debug like you're playing Whack-a-Mole... blindfolded!",
      category: "tech",
    },
    {
      template:
        "{opponent}, your algorithms are slower than a 56k modem downloading the internet!",
      category: "tech",
    },
    {
      template:
        "Hey {opponent}, Stack Overflow has a restraining order against your questions!",
      category: "tech",
    },
    ...
    {
      template:
        "{opponent}, you're so bad at gaming that NPCs feel sorry for you!",
      category: "gaming",
    },
    {
      template:
        "Yo {opponent}, you respawn more often than a glitched character!",
      category: "gaming",
    },
    {
    ...
    {
      template:
        "Listen {opponent}, lag isn't an excuse when you're playing solitaire!",
      category: "gaming",
    },
    ...
    {
      template:
        "{opponent}, you're like a participation trophy - everyone gets one, but nobody wants it!",
      category: "general",
    },
    {
      template:
        "Hey {opponent}, if being awesome was a crime, you'd be law-abiding!",
      category: "general",
    },
    {
      template:
        "{opponent}, you're proof that even artificial intelligence has limits!",
      category: "general",
    },
    {
      template:
        "Sup {opponent}, you're like a broken GPS - always lost and never helpful!",
      category: "general",
    },
    ...
    {
      template:
        "{opponent}, your avatar looks like it was designed by a committee of blind artists!",
      category: "appearance",
    },
    {
      template:
        "Yo {opponent}, even your profile picture is trying to log out!",
      category: "appearance",
    },
    {
      template:
        "{opponent}, your style is so outdated that retro fashion called and wants its look back!",
      category: "appearance",
    },
  ];
  ...
  generateInsult(
    opponent: string,
    category?: InsultTemplate["category"]
  ): string {
    ...
    const randomInsult =
      availableInsults[Math.floor(Math.random() * availableInsults.length)];
  ...
  generateMotivationalTrashTalk(opponent: string): string {
    const randomMotivation =
      this.motivationalInsults[
        Math.floor(Math.random() * this.motivationalInsults.length)
      ];
